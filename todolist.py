...
Windows/ Ubuntu Linux/ Mac Compatible
Technologies Used: tkinter, grid geometry manager,Listbox Widget,
Scrollbar widget, tkinter.messagebox, Try/Except Blocks, pickle
"""
...
root = tkinter.Tk()
root.title("To-Do List by GeoAyl")
